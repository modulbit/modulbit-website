    ...
    <nav className="sticky top-0 z-50 w-full border-b border-white/5 bg-[#181d24] px-6 py-4 shadow-2xl backdrop-blur-md">
      <div className="mx-auto flex max-w-7xl items-center justify-between">
        ...
        <div className="flex items-center gap-6">
          ...
          <Link href="/get-involved" className="group relative overflow-hidden rounded-full bg-transparent px-8 py-2.5 text-sm font-semibold text-accent transition-all duration-300 hover:text-white border border-accent/30 hover:border-accent hover:shadow-[0_0_20px_rgba(0,255,157,0.3)]">
